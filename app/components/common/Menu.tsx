...
const Menu = ({
  ...
  return (
    <>
      ...
      <div
        className={clsx(
          "fixed bg-white h-screen w-[550px] top-[2vh] left-4 opacity-0 pointer-events-none transition-all duration-500 -translate-x-48 px-[50px] py-[36px] z-40 2xl:h-[96vh] rounded-lg shadow-lg",
